...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessagesList = __webpack_require__(/*! ./components/MessagesList.jsx */ 160);
	...
	var App = function (_React$Component) {
		...
		function App(props) {
			...
			_this.state = { value: '', messages: [] };
	
			_this.connection = new _connection2.default();
	
			_this.connection.socket.on('chat message recieved', function (message) {
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('input', { type: 'text', value: this.state.value, onChange: this.onChangeText.bind(this) }),
